...
(function (jQuery) {
  ...
  // jQuery('li.active > a[aria-expanded="false"]').attr("aria-expanded", "true");
    ...
    var collapsables = document.querySelectorAll('a[data-toggle="collapse"]');
    for (let i = 0; i < collapsables.length; i++) {
        collapsables[i].addEventListener('click', function(){
            var menu = document.querySelector('a[aria-expanded="true"]');
            var checker = this.attributes['aria-expanded'].value =='false';
            if(menu){
...
// {
//   [].forEach.call(collapsables, (element)=>{
//          element.addEventListener('click', ()=>{
//              var target = element.href.substr(element.href.indexOf('#'));
//             var parentElement = element.parentNode;
//             if (parentElement != null)
//             {
//                 var childElement = parentElement.querySelector(target);
...
//                 else
//                 {
//                      childElement.classList.add('activeee');
//                     //  parentElement.classList.add('activee');

//                      var parent = document.querySelector('#iq-sidebar-toggle');
                    
//                     if (parent != null)
//                     {
//                       var activeSubMenu  = parent.querySelectorAll('.iq-submenu.collapse.show');
                        
//                         if (activeSubMenu.length > 0)
//                         {
//                             [].forEach.call(activeSubMenu, (submenu)=>{
//                                 submenu.classList.remove('show');
//                                 var submenuAnchor = submenu.parentNode.querySelector('a[data-toggle="collapse"]');
//                                 if (submenuAnchor != null) submenuAnchor.setAttribute('aria-expanded', 'false');
//                             });
//                         }
//                     }
